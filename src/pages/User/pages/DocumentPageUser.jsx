    ...
    <div>
      <DefaultLayoutPage>
        <div className='bg-white p-3 md:px-12 md:py-8 lg:px-20 lg:py-14 xl:px-40 xl:py-20 '>
          ...
          <div className='mt-12'>
            <Pagination total={85} size='large' defaultPageSize={20} defaultCurrent={1} responsive />
          </div>
        </div>
      </DefaultLayoutPage>
      <ModalFormDocs
      ...
      >
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus ratione culpa unde repudiandae iure
          perspiciatis nam, fugiat maiores nihil obcaecati aut, rerum, mollitia suscipit beatae nemo? Sint ipsam quo ex?
        </p>
      </ModalFormDocs>
    </div>
  );
