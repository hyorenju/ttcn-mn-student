  ...
  return (
    <>
      <section className={`relative w-full `}>
        <img src={contact} alt='contact' className='absolute w-full h-full object-cover brightness-75' />
        <div className='w-full p-4 md:p-6 lg:p-10 xl:p-20 flex items-center justify-center'>
          ...
          <div className='flex-1 z-50'>
            ...
            <p className='max-w-[650px] text-white mb-5 text-sm lg:text-xl xl:text-2xl mt-2 md:mt-3 lg:mt-4'>
              Có điều gì thắc mắc hay đóng góp ý kiến cá nhân hãy gửi cho chúng tôi bạn sẽ nhận được giải đáp sớm nhất.
              Xin cảm ơn !
            </p>
