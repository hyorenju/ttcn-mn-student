...
import { EnvironmentFilled, FacebookOutlined, LinkedinOutlined, TwitterOutlined } from '@ant-design/icons';
    ...
    <div>
      <footer className='flex w-full flex-col gap-6 md:flex-row justify-between p-4 md:p-6 lg:px-14 lg:py-8 border-b bg-[#005B30] text-white '>
        <div className='text-white'>
          ...
          <p className='mb-3 text-sm lg:text-xl'>Điện thoại: (024) 62617701 – Fax: (024) 38276554</p>
          <p className='mb-3 text-sm lg:text-xl'>Email: cntt@vnua.edu.vn - Website: https://fita.vnua.edu.vn</p>
