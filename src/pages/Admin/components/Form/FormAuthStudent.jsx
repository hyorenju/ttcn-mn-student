...
function FormAuthStudent(props) {
  ...
  const onFinish = (values) => {
    ...
    updateAuthorizationAdmin({ id: 'STUDENT', permissionIds: valueUpdate })
      .then((res) => {
        if (res.data?.success === true) {
          handleGetValuesInitPermissions();
          setLoadingBtn(false);
...
export default FormAuthStudent;
